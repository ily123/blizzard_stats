...
class RioScraper:
    '''
    Wrapper to generate API calls to raider.io dungeon run database
...
class RioResponseParser:
    '''
    Parser to extract relevant data from Rio dungeon run jsons
    ...
    def unroll(self):
        ...
        # convert each to a dict, and add to the list
        data_list = []
    ...
    def handle_roster(self, roster):    
        ...
        -------
        roster_dict : dict
            dictionary where keys are specs and values is the number of 
            players of that spec in the run
        '''
        roster_dict = {}
